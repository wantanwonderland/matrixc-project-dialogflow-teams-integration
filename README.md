...
```
gcloud builds submit --tag gcr.io/$PROJECTID/azurebottest

gcloud run deploy \
--image gcr.io/$PROJECTID/azurebottest \
--service-account=$SERVICE_ACCOUNT \
--set-env-vars MICROSOFT_APP_ID=$MICROSOFT_APP_ID \
--set-env-vars MICROSOFT_APP_PASSWORD=$MICROSOFT_APP_PASSWORD \
--set-env-vars PROJECT_ID=$PROJECT_ID \
--set-env-vars LOCATION=$LOCATION \
--set-env-vars AGENT_ID=$AGENT_ID \
--set-env-vars DIALOGFLOW_ENDPOINT=$DIALOGFLOW_ENDPOINT
